...
declare module "@altv/server" {
  ...
  export class Player extends Entity {
    ...
    setAmmoSpecialType(
      ...
      specialType: altShared.Enums.AmmoSpecialType
    ): void;
  ...
  export namespace Events {
    ...
    export function emitPlayersUnreliable<
    ...
    >(
      eventName: E,
      callback: CustomPlayerEventCallback<
        Parameters<altShared.Events.CustomPlayerToServerEvent[E]>,
        U
      >
    ): altShared.Events.ScriptEventHandler;
    ...
    export function onceRemote<
      E extends keyof altShared.Events.CustomRemoteEvent,
      U extends Player
    >(
      eventName: E,
      callback: CustomPlayerEventCallback<Parameters<altShared.Events.CustomRemoteEvent[E]>, U>
    ...
    export type GenericEventCallback<T extends {} = {}> = (
      params: T & EventContext
    ) => void | Promise<void>;
