import { bool, generate, num, obj, str } from "./base.js";

process.exit(generate('voice.toml', () => ({
  secret: num('ALTV_VOICE_EXTERNAL_SECRET') ?? 0,
  host: str('ALTV_HOST'),
  port: num('ALTV_VOICE_EXTERNAL_PORT'),
  playerHost: str('ALTV_HOST'),
  playerPort: num('ALTV_VOICE_EXTERNAL_PUBLIC_PORT'),
