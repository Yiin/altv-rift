...
import { WeaponComponent, WeaponItemKey, getItemName, createItem, Metal, ItemComponents } from "@shared/modules/items";
  ...
  Object.entries({
    ...
    registerBlueprint({
      ...
      recipes: components.map((component) => ({
        ...
        parts: [
          createItem(Metal.COMMON_METAL, {
            amount: 5 * (+component[component.length - 1] || 1),
          }),
          createItem(ItemComponents.COMMON_ITEM_COMPONENTS, {
            amount: 5 * (+component[component.length - 1] || 1),
          }),
        ],
        levelRequired: 5,
