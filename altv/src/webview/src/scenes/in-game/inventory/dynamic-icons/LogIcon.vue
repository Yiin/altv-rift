...
import { type TreeLogItemKey } from "@shared/modules/items/registry/materials/tree-log.items";

const props = defineProps<{
  itemKey: TreeLogItemKey;
}>();
  ...
  () =>
    (
      ({
        ...
        oak_logs: "#AB7343",
        pine_logs: "#7D9D72",
      }) as Record<TreeLogItemKey, string>
    )[props.itemKey],
);
</script>
