...
function addItem(item: { key: string; price: number; grade?: string }) {
...
<template>
  <Card>
    <CardHeader>
      ...
      <CardDescription>Shops are places where players can buy items.</CardDescription>
    </CardHeader>
    <CardContent>
      <form
        @submit="onSubmit"
                    ...
                    <div class="space-y-2">
                      ...
                      <ul class="space-y-2">
                        <li
                          ...
                          :key="item.key"
                          class="flex items-center justify-between rounded bg-neutral-900 p-2"
                        >
