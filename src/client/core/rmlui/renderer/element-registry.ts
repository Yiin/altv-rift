...
export const registeredElements = new Map<string, ElementRegistration<AnchorType, any>>();

export const focusableElements = new Map<AnchorType, ElementRegistration<AnchorType, any>>();
