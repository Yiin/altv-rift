...
export enum STATS_DISPLAY_TYPE {
...
export enum FRONTEND_SHOW_FLAG {
...
export enum  CLOUD_LOAD_FAILURE_CODES {
...
export enum  CLOUD_SAVE_FAILURE_CODES {
...
export enum CLOUD_ONLINE_SERVICE {
...
/*
Legend for export enum SAVE_TYPE: {
...
NATIVE FUNC BOOL STAT_GET_CODER_STAT(STATSexport enum keyHash) = "0x66eb2b1dfefb88f9" {

/// PURPOSE:
///    Returns the hash value of the stat ID.
/// PARAMS:
///    str - stat id.
NATIVE FUNC STATSexport enum STAT_HASH_ID(STRING str) = "0x7125cd61d5aeddec" {

/// PURPOSE:
///    Returns TRUE is the stat key is valid.
NATIVE FUNC BOOL STAT_IS_KEY_VALID(STATSexport enum keyHash) = "0x8c40bf5bd821e5c6" {

/// PURPOSE:  Access a stat name - DEBUG ONLY command.
NATIVE FUNC STRING STAT_GET_NAME(STATSexport enum keyHash) = "0x6112c354da434263" {

/// PURPOSE:  Access a stat gxt label id.
NATIVE FUNC INT STAT_GET_LABEL_ID(STATSexport enum keyHash) = "0x1427950c22782a0c" {

/// PURPOSE:  Access a stat gxt label.
NATIVE FUNC STRING STAT_GET_LABEL(STATSexport enum keyHash) = "0x4f34a23778ecf4dd" {

/// PURPOSE:  Access a stat gxt description.
NATIVE FUNC STRING STAT_GET_DESCRIPTION(STATSexport enum keyHash) = "0x0ebe6b3d14ce019b" {

/// PURPOSE:  Access a stat denominator label.
NATIVE FUNC INT STAT_GET_DENOMINATOR(STATSexport enum keyHash) = "0x27c28df3d6afc785" {

/// PURPOSE:  Set the value of an Int, UInt8, UInt16, UInt32 and UInt64 stat.
NATIVE FUNC BOOL STAT_SET_INT(STATSexport enum keyHash, INT data, BOOL coderAssert = true) = "0x076a5661ef5abee4" {

/// PURPOSE:  Set the value of an Float stat.
NATIVE FUNC BOOL STAT_SET_FLOAT(STATSexport enum keyHash, FLOAT data, BOOL coderAssert = true) = "0xd9b28f1445ffcee7" {

/// PURPOSE:  Set the value of an boolean stat.
NATIVE FUNC BOOL STAT_SET_BOOL(STATSexport enum keyHash, BOOL data, BOOL coderAssert = true) = "0x41483427efbc0047" {

/// PURPOSE:  Set the value of an String stat.
NATIVE FUNC BOOL STAT_SET_GXT_LABEL(STATSexport enum keyHash, STRING data, BOOL coderAssert = true) = "0xa83328d394deaa9f" {

/// PURPOSE:  Set the value of an Date stat.
NATIVE FUNC BOOL STAT_SET_DATE(STATSexport enum keyHash, STRUCT& data, int sizeOfData, BOOL coderAssert = true) = "0x8147c3d3000a3094" {

/// PURPOSE:  Set the value of an Date stat.
NATIVE FUNC BOOL STAT_SET_STRING(STATSexport enum keyHash, STRING data, BOOL coderAssert = true) = "0x6e74a171535f0808" {

/// PURPOSE:  Set the value of an Date stat.
NATIVE FUNC BOOL STAT_SET_POS(STATSexport enum keyHash, FLOAT X, FLOAT Y, FLOAT Z, BOOL coderAssert = true) = "0x14acf0cbd3e0dfb8" {
...
// 
NATIVE FUNC BOOL STAT_SET_MASKED_INT(STATSexport enum keyHash, INT data, INT offSet, INT numberOfBits, BOOL coderAssert = true) = "0xe2ea061e6f7b236f" {

/// PURPOSE:  Set the value of an user id stat.
NATIVE FUNC BOOL STAT_SET_USER_ID(STATSexport enum keyHash, STRING data, BOOL coderAssert = true) = "0xed186f54433a4358" {

/// PURPOSE:  Set the current posix time in a stat.
NATIVE FUNC BOOL STAT_SET_CURRENT_POSIX_TIME(STATSexport enum keyHash, BOOL coderAssert = true) = "0x39ba1f3b9759059d" {

/// PURPOSE:  Get the value of an Int, UInt8, UInt16, UInt32 and UInt64 stat.
NATIVE FUNC BOOL STAT_GET_INT(STATSexport enum keyHash, INT& data, INT playerIndex = -1) = "0x61481f9fbb1c7edd" {

/// PURPOSE:  Get the value of an Float stat.
NATIVE FUNC BOOL STAT_GET_FLOAT(STATSexport enum keyHash, FLOAT& data, INT playerIndex = -1) = "0x9a69a54179cea8e5" {

/// PURPOSE:  Get the value of an boolean stat.
NATIVE FUNC BOOL STAT_GET_BOOL(STATSexport enum keyHash, BOOL& data, INT playerIndex = -1) = "0x1bb27397611554ce" {

/// PURPOSE:  Get the value of an String stat.
NATIVE FUNC BOOL STAT_GET_GXT_LABEL(STATSexport enum keyHash, INT& data, INT playerIndex = -1) = "0x7354a4c703aaeb34" {

/// PURPOSE:  Get the value of an Date stat.
NATIVE FUNC BOOL STAT_GET_DATE(STATSexport enum keyHash, STRUCT& data, int sizeOfData, INT playerIndex = -1) = "0x585e6867d0d71962" {

/// PURPOSE:  Get the value of an String stat.
NATIVE FUNC STRING STAT_GET_STRING(STATSexport enum keyHash, INT playerIndex = -1) = "0xafca9e302ef8c3e0" {

/// PURPOSE:  Get the value of an String stat.
NATIVE FUNC BOOL STAT_GET_POS(STATSexport enum keyHash, FLOAT& X, FLOAT& Y, FLOAT& Z, INT playerIndex = -1) = "0x335be6bc12888abe" {
...
//
NATIVE FUNC BOOL STAT_GET_MASKED_INT(STATSexport enum keyHash, INT& data, INT offSet, INT numberOfBits, INT playerIndex = -1) = "0xf881d9ecfc43b6ea" {

/// PURPOSE:  Get the value of an User Id stat.
NATIVE FUNC STRING STAT_GET_USER_ID( STATSexport enum keyHash ) = "0x45a1e17ec0480db4" {

/// PURPOSE:  Get the Posix time difference from the posix time stored in the stat value.
NATIVE FUNC INT STAT_GET_POSIX_TIME_DIFFERENCE( STATSexport enum keyHash ) = "0x485eee9aae9f082b" {
...
///    keyHash - stat id.
///    value - 
NATIVE PROC STAT_INCREMENT(STATSexport enum keyHash, FLOAT value) = "0xfa38cf6ffd2bf050" {
...
///    keyHash - stat id.
///    value - 
NATIVE PROC STAT_DECREMENT(STATSexport enum keyHash, FLOAT value) = "0x155e99bf32775ddc" {
...
///    keyHash - stat id.
///    value - 
NATIVE PROC STAT_SET_GREATER(STATSexport enum keyHash, FLOAT value) = "0x53b0eb1ed6aea380" {
...
///    keyHash - stat id.
///    value - 
NATIVE PROC STAT_SET_LESSER(STATSexport enum keyHash, FLOAT value) = "0x537b9584db71d36c" {
...
///    keyHash - stat id.
///    flag - 
NATIVE PROC STAT_SET_FRONTEND_VISIBILITY_FLAG(STATSexport enum keyHash, FRONTEND_SHOW_FLAG flag) = "0xffce250441ce7e62" {
...
/// PARAMS:
///    keyHash - stat id.
NATIVE FUNC INT STAT_GET_FRONTEND_VISIBILITY_FLAG(STATSexport enum keyHash) = "0xb9bd912d7964eefa" {

/// PURPOSE:
///    Returns TRUE is the stat type supports STRINGS.
/// PARAMS:
///    keyHash - stat id.
NATIVE FUNC BOOL STAT_GET_SUPPORTS_STRINGS(STATSexport enum keyHash) = "0x591ea0765690adce" {

/// PURPOSE:
///    Returns TRUE is the stat type supports LABELS.
/// PARAMS:
///    keyHash - stat id.
NATIVE FUNC BOOL STAT_GET_SUPPORTS_LABELS(STATSexport enum keyHash) = "0x6cb367057d418b9e" {
...
NATIVE FUNC INT STAT_GET_NUMBER_OF_DAYS(STATSexport enum keyHash) = "0xdb9dd213ed802a90" {
NATIVE FUNC INT STAT_GET_NUMBER_OF_HOURS(STATSexport enum keyHash) = "0x0896ca1f4f0d8af1" {
NATIVE FUNC INT STAT_GET_NUMBER_OF_MINUTES(STATSexport enum keyHash) = "0xbb9770585f7d56a2" {
NATIVE FUNC INT STAT_GET_NUMBER_OF_SECONDS(STATSexport enum keyHash) = "0x687230a23f87a4cb" {
...
NATIVE PROC PRESENCE_EVENT_UPDATESTAT_INT(STATSexport enum statId, INT value, INT value2 = 0) = "0x423a6008ceed5d6c" {
NATIVE PROC PRESENCE_EVENT_UPDATESTAT_FLOAT(STATSexport enum statId, FLOAT value, INT value2 = 0) = "0x4115628326810a31" {
NATIVE PROC PRESENCE_EVENT_UPDATESTAT_INT_WITH_STRING(STATSexport enum statId, INT value, INT value2, STRING stringData) = "0xcc0d9986102e9b4f" {
NATIVE PROC PRESENCE_EVENT_UPDATESTAT_FLOAT_WITH_STRING(STATSexport enum statId, FLOAT value, INT value2, STRING stringData) = "0x5c17293d8f69a65d" {
...
export enum LEADERBOARDS2_TYPES_ENUM {
...
STRUCT Leaderboard2ReadData
	...
	//Type of read 
	LEADERBOARDS2_TYPES_export enum  m_Type {
...
///           Maximum depth is 5.
NATIVE FUNC BOOL STAT_COMMUNITY_GET_HISTORY(STATSexport enum keyHash, INT depth, float& returnData) = "0xb4455b84f602b40d" {
...
NATIVE FUNC STATSexport enum GET_PACKED_BOOL_STAT_KEY(ENUM_TO_INT stat, BOOL singlePlayer, BOOL isCharacater, INT char) = "0x27df3e7d400669bb" {
NATIVE FUNC STATSexport enum GET_PACKED_INT_STAT_KEY(ENUM_TO_INT stat, BOOL singlePlayer, BOOL isCharacater, INT char) = "0xf66585648257e5b9" {
NATIVE FUNC STATSexport enum GET_PACKED_TU_BOOL_STAT_KEY(ENUM_TO_INT stat, BOOL singlePlayer, BOOL isCharacater, INT char) = "0xe03cb2510772a1a6" {
NATIVE FUNC STATSexport enum GET_PACKED_TU_INT_STAT_KEY(ENUM_TO_INT stat, BOOL singlePlayer, BOOL isCharacater, INT char) = "0xc3fad245f85182fa" {
NATIVE FUNC STATSexport enum GET_PACKED_NG_BOOL_STAT_KEY(ENUM_TO_INT stat, BOOL singlePlayer, BOOL isCharacater, INT char, STRING baseKey) = "0x2da085b3addad1ac" {
NATIVE FUNC STATSexport enum GET_PACKED_NG_INT_STAT_KEY(ENUM_TO_INT stat, BOOL singlePlayer, BOOL isCharacater, INT char, STRING baseKey) = "0x246883873095b181" {
...
NATIVE FUNC BOOL STAT_GET_BOOL_MASKED(STATSexport enum keyHash, INT bitField, INT playerIndex = -1) = "0xb0546d69db2298a1" {
/// PURPOSE:  Set a bool value from a packed stat.
NATIVE FUNC BOOL STAT_SET_BOOL_MASKED(STATSexport enum keyHash, BOOL Value, INT bitField, BOOL CoderReset = TRUE) = "0x77af9853b955948e" {
...
///    keyHash - stat id.
///    value - 
NATIVE PROC STAT_NETWORK_INCREMENT_ON_SUICIDE(STATSexport enum keyHash, FLOAT value) = "0x4ec5e38b70b5ac89" {
...
NATIVE FUNC BOOL STAT_SET_LICENSE_PLATE( STATSexport enum keyHash, STRING licensePlate ) = "0xce9b2b59b53a67c6" {

/// PURPOSE:  Get the value of a License Plate.
NATIVE FUNC STRING STAT_GET_LICENSE_PLATE( STATSexport enum keyHash ) = "0x378cf7462fea8a28" {
...
export enum MIGRATION_PLATFORM {
	PLATFORM_XBOX360,
	PLATFORM_XBOXONE,
	PLATFORM_PS3,
	PLATFORM_PS4,
...
//Save migration error codes.
export enum MIGRATION_RESULT_CODES {
...
//Save migration error codes.
export enum SAVE_MIGRATION_STATUS {
...
export enum CANCEL_SAVE_MIGRATION_STATUS {
	CSMS_NONE,
	CSMS_PENDING,
	CSMS_FAILED,
	CSMS_SUCCEDDED,
...
//Status for the migrate save operations.
export enum COMSUME_CONTENT_ERROR_CODE {
        ERROR_UNKNOWN = -1,
        ERROR_NONE = 0,
        //(ConsumeContentUnlock) The source account has already been used to unlock this content for another account
...
export enum RECORD_STAT_POLICY {
        RSP_SUM = 1, 
		RSP_GREATEST = 2,
		RSP_LOWEST = 3
}
