...
export enum SET_PLAYER_CONTROL_FLAGS {
...
export enum ASSISTED_MOVEMENT_FLAGS {
...
export enum WRECKLESS_TYPE {
	WT_ON_PAVEMENT = 0,
	WT_RAN_RED_LIGHT,
	WT_DROVE_AGAINST_TRAFFIC
}

export enum TARGETING_MODE_TYPE {
...
export enum PLAYER_TARGET_LEVEL {
	PTL_TARGET_EVERYONE = 0,
	PTL_TARGET_STRANGERS,
	PTL_TARGET_ATTACKERS
}

export enum CLOTH_PACKAGE_TYPE {
...
export enum ARCADE_PASSIVE_ABILITY_TYPE {
...
export enum ARCADE_SPECIAL_ABILITY_TYPE {
...
export enum ARCADE_VEHICLE_ABILITY_TYPE {
...
export enum INCAPACITATION_STATE {
