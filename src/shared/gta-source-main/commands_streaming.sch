...
export enum STREAMVOL_ASSET_TYPES {
    FLAG_COLLISIONS_MOVER			= 1,
    FLAG_COLLISIONS_WEAPON			= 2,
    FLAG_MAPDATA					= 12
}

export enum STREAMVOL_LOD_FLAGS {
...
export enum NEWLOADSCENE_FLAGS {
...
export enum SHORT_SWITCH_STATE {
...
export enum SHORT_SWITCH_STYLE {
...
export enum SRL_PRESTREAM_MODE {
