...
export enum SCRIPT_EVENT_QUEUES {
...
//		   
export enum NETWORK_REASON_PED_LEFT_BEHIND {
...
//		   invite session. For others, check with code or display general message
//		   
export enum JOIN_RESPONSE_CODE {
...
export enum ARREST_EVENT_TYPES {
