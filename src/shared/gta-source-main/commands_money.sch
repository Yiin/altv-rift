...
export enum PAYMENT_REFUSED_REASON {
	PRR_UNKNOWN,
...
export enum SELLING_VEHICLE_TYPE {
...
export enum eStripClubExpenditureType {
	LAP_DANCE
	,WATCHING_THE_POLE
	,DRINKING_AT_THE_BAR
}
...
export enum GANGOPS_AWARD_TYPE {
...
export enum GANGOPS_ELITE_TYPE {
...
export enum MEMBERSHIP_PURCHASE_METHOD {
