...
export enum BRIANS_MOOD {
	BRIANS_MOOD_CLEAN = 0,
	BRIANS_MOOD_DRUG	//	1
}

export enum AUD_ANIMAL_MOOD {
...
export enum AUD_CONTEXT_BLOCK_TARGET {
...
export enum POLICE_SCANNER_CAR_CODE {
	CAR_CODE_A,
	CAR_CODE_B,
	CAR_CODE_C,
	CAR_CODE_D,
...
export enum AUD_AIRCRAFT_WARNING_TYPES {
...
export enum AUDIO_VEHICLE_PRIORITY {
...
export enum AUDIO_SPECIAL_EFFECT_MODE {
