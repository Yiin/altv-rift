...
export enum RAY_FIRE_MAP_OBJECT_STATE {
...
export enum PICKUP_REWARD_TYPE {
...
export enum ANIMATED_BUILDING_RATE_FLAGS {
	AB_RATE_RANDOM = 1		// 1 << 0
}

export enum ANIMATED_BUILDING_PHASE_FLAGS {
...
NATIVE PROC DOOR_SYSTEM_SET_DOOR_STATE(int doorEnumHash, DOOR_STATE_export enum state, BOOL network = TRUE, BOOL flushState = FALSE) = "0x7e15597aa5f53f9a" {

//INFO: 
//PARAM NOTES:
//PURPOSE: Get the state of a door managed by the door system
NATIVE FUNC DOOR_STATE_export enum DOOR_SYSTEM_GET_DOOR_STATE(int doorEnumHash) = "0xa570d693c4a2b421" {

//INFO: 
//PARAM NOTES:
//PURPOSE: Get the pending state of a door managed by the door system
NATIVE FUNC DOOR_STATE_export enum DOOR_SYSTEM_GET_DOOR_PENDING_STATE(int doorEnumHash) = "0xdc62e683fb337ec3" {
...
export enum SEARCH_LOCATION_FLAGS {
