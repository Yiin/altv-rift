...
export enum DECAL_RENDERSETTING_ID {
...
export enum CREWEMBLEMREQUESTSTATE {
	CERS_NOT_ACTIVE = 0,
...
export enum ANIMPOSTFX_EVENT_TYPE {
...
export enum PHOTO_OPERATION_STATUS {
...
export enum eLowQualityPhotoSetting {
