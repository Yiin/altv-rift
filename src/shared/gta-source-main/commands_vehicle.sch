...
export enum SC_WHEEL_LIST              //CAR_WHEEL_TYPE {
...
export enum SC_DOOR_LIST               //CAR_DOOR_TYPE {
	SC_DOOR_INVALID = -1,
...
export enum SC_WINDOW_LIST             //CAR_WINDOW_TYPE {
...
export enum VEHICLE_LIGHT_SETTING {
...
export enum VEHICLE_HEADLIGHT_SHADOW_FLAGS {
...
export enum CUSTOM_PLATE_DESIGNS {
...
export enum VEHICLE_LAYOUT_TYPE {
    LAYOUT_INVALID			= 0,
...
export enum PLAYBACKDISPLAYMODE {
    RDM_NONE = 0,
    RDM_WHOLELINE,
    RDM_JUSTINFRONT,
    RDM_JUSTBEHIND,
...
export enum LANDING_GEAR_COMMAND {
    LGC_DEPLOY = 0,
    LGC_RETRACT,
    LGC_DEPLOY_INSTANT,
    LGC_RETRACT_INSTANT,
...
export enum CONVERTIBLE_ROOF_STATE {
    CRS_RAISED,
    CRS_LOWERING,
    CRS_LOWERED,
    CRS_RAISING,
...
export enum VEHICLE_PLATE_TYPE {
...
export enum VEHICLE_RESOURCE_FLAGS {
...
export enum PICKUP_GADGET_TYPE {
	PICKUP_HOOK,
	PICKUP_MAGNET
}

export enum PLANE_DAMAGE_SECTION {
	WING_L,
	WING_R,
	TAIL,
	ENGINE_L,
...
export enum LANDING_GEAR_DAMAGE_SECTION {
	GEAR_F,
	GEAR_RL,
	GEAR_LM1,
	GEAR_RM,
...
export enum RELEASE_TRAIN_FLAGS {
	RTF_DEFAULT				= 0,
...
export enum HOMING_LOCKON_STATE {
	HLOS_NONE		= 0,
	HLOS_ACQUIRING	= 1,	
	HLOS_ACQUIRED	= 2
}
...
//PURPOSE: Sets the vehicle headlight shadow flags. see export enum VEHICLE_HEADLIGHT_SHADOW_FLAGS, for valid values {
...
export enum VEHICLE_RECORDING_PLAYBACK_FLAGS {
...
export enum WHEEL_HYDRAULIC_SCRIPT_STATE  {
	HS_WHEEL_FREE = 0,
	HS_WHEEL_LOCKED,
	HS_WHEEL_BOUNCE,
