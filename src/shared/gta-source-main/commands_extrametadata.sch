...
export enum TATTOO_FACTION_ENUM {
	TATTOO_SP_MICHAEL = 0,
	TATTOO_SP_FRANKLIN,
	TATTOO_SP_TREVOR,
	TATTOO_MP_FM
...
NATIVE FUNC INT GET_NUM_TATTOO_SHOP_DLC_ITEMS(TATTOO_FACTION_export enum tattoo_faction) = "0x883e6f2863a2c982" {
...
NATIVE FUNC BOOL GET_TATTOO_SHOP_DLC_ITEM_DATA(TATTOO_FACTION_export enum tattoo_faction, INT tattooIndex, sTattooShopItemValues& out_Values) = "0x7a1b82e97e3bd5be" {
...
NATIVE FUNC INT GET_TATTOO_SHOP_DLC_ITEM_INDEX(TATTOO_FACTION_export enum tattoo_faction, INT collectionHash, INT presetHash) = "0x35f01d0bcdf83b24" {
