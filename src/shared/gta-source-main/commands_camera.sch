...
export enum CAMERA_GRAPH_TYPE			// These are graph which apply as a modifier to the default speed OR time of some motion. {
...
export enum CAM_VIEW_MODE_CONTEXT {
...
// NOTE: This enum is deprecated. Please use CAM_VIEW_MODE instead
export enum VEHICLE_ZOOM_LEVEL  {
...
export enum CAM_SPLINE_NODE_FLAGS {
...
// Allows for custom options to be specified for the node of a camera spline. Must match camSplineNode::eFlags in camera/helpers/SplineNode.h
export enum CAM_SPLINE_NODE_FORCE_FLAGS {
...
export enum CAM_SPLINE_SMOOTHING_FLAGS {
...
export enum RENDERING_OPTION_FLAGS {
	RO_NO_OPTIONS = 0,
...
export enum CAM_ANIMATION_FLAGS {
	CAF_DEFAULT = 0,													//					
...
export enum CAM_IN_VEHICLE_STATE {
...
export enum CAM_DEATH_FAIL_EFFECT_STATE {
	CAM_DEATH_FAIL_EFFECT_INACTIVE		= 0,
	CAM_DEATH_FAIL_EFFECT_INTRO			= 1,
	CAM_DEATH_FAIL_EFFECT_OUTRO			= 2
}

export enum FPS_FLASH_TYPE			// These are graph which apply as a modifier to the default speed OR time of some motion. {
...
export enum TABLE_GAMES_CAMERA_TYPE {
