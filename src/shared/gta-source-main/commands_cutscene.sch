...
export enum CUTSCENE_ENTITY_OPTION_FLAGS {
	CEO_NONE = 0,						
...
export enum CUTSCENE_PLAYBACK_FLAGS {
...
export enum CUTSCENE_OPTION_FLAGS {
...
export enum CUTSCENE_HANDLE_SEARCH_RESULT {
...
export enum CUTSCENE_ENTITY_STREAMING_FLAGS {
	CES_NONE = 0,	
