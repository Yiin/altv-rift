...
export enum CLEAROBJECTS_FLAGS {
...
export enum SAVEGAME_OPERATION_STATUS {
...
// ENSURE IN SYNC WITH export enum ePhoneInput IN TASKMOBILEPHONE.H {
export enum CELL_INPUT {
	CELL_INPUT_NONE,
    CELL_INPUT_UP,
	CELL_INPUT_DOWN,
	CELL_INPUT_LEFT,
...
export enum TENNIS_DIVE_DIRECTION {
    DIVE_BH = 0,
	DIVE_FH
}
