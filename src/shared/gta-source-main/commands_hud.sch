...
//
export enum FRONTEND_MENU_SCREEN {
...
export enum eHELP_TEXT_FLOATING_ID {
...
export enum eWIDESCREEN_FORMAT {
...
export enum eMOUSE_POINTER_STYLE {
...
export enum eMOUSE_EVT // must match Code and AS enum {
...
export enum eMINIMAP_GOLF_COURSE_HOLE {
...
//
export enum eMINIMAP_COMPONENT {
...
export enum BLIP_CATEGORY   // NOTE THAT THIS ENUM MUST NEVER START AT ANYTHING OTHER THAN '2' IN ORDER TO WORK WITH CODE! {
...
export enum COUNTER_DISPLAY_METHOD {
    COUNTER_DISPLAY_NUMBER = 0,
    COUNTER_DISPLAY_BAR
}

export enum FONT_ORIENTATION {
    FO_CENTRE = 0,
    FO_LEFT,
    FO_RIGHT
}

export enum HELP_MESSAGE_STYLE {
...
export enum ZONE_MARK_TYPE {
    ZM_CIRCLE,
    ZM_RECTANGLE
}

export enum eWIDGET_NAME {
    FE_TOP_LINE_POS = 0,
    FE_TOP_TEXT_POS,
    FE_TOP_TEXT_SIZE,
    FE_TOP_TEXT_SPACE,
...
export enum SCRIPT_PRINT_EXTRA_PARAMS {
...
export enum TEXT_COMPONENT_TIME_FORMAT {
...
export enum TEXT_COMPONENT_INTEGER_FORMAT {
...
export enum ePreviousBriefOverride {
...
export enum eTextJustification {
	FONT_CENTRE = 0,
	FONT_LEFT,			//	Default
	FONT_RIGHT,
	FONT_JUSTIFY
...
export enum WARNING_MESSAGE_FLAGS {
...
NATIVE FUNC BOOL GET_MENU_PED_INT_STAT(STATSexport enum keyHash, INT& data) = "0x08c246faea34e413" {

/// PURPOSE:  Get the value of an Int, UInt8, UInt16, UInt32 and UInt64 stat for a specific character slot
NATIVE FUNC BOOL GET_CHARACTER_MENU_PED_INT_STAT(STATSexport enum keyHash, INT& data, INT characterSlot = -1) = "0x12fa79d99f6d66db" {

/// PURPOSE:  Get the value of an masked Int, UInt8, UInt16, UInt32 and UInt64 stat.
NATIVE FUNC BOOL GET_MENU_PED_MASKED_INT_STAT(STATSexport enum keyHash, INT& data, INT offSet, INT numberOfBits) = "0x344ecddc16c7def1" {

/// PURPOSE:  Get the value of an masked Int, UInt8, UInt16, UInt32 and UInt64 stat.
/// NOTE:  This allows scripters to specify a character slot.
NATIVE FUNC BOOL GET_CHARACTER_MENU_PED_MASKED_INT_STAT(STATSexport enum keyHash, INT& data, INT offSet, INT numberOfBits, INT characterSlot) = "0x4f46ae5cc69707ce" {

/// PURPOSE:  Get the value of an Float stat.
NATIVE FUNC BOOL GET_MENU_PED_FLOAT_STAT(STATSexport enum keyHash, FLOAT& data) = "0x33a710bcac7ab802" {

/// PURPOSE:  Get the value of an Float stat for a character slot.
NATIVE FUNC BOOL GET_CHARACTER_MENU_PED_FLOAT_STAT(STATSexport enum keyHash, FLOAT& data, INT characterSlot = -1) = "0x86b9025b867d9380" {

/// PURPOSE:  Get the value of an boolean stat.
NATIVE FUNC BOOL GET_MENU_PED_BOOL_STAT(STATSexport enum keyHash, BOOL& data) = "0x7470d10647b74302" {

/// PURPOSE:  Get the value of an boolean stat for a character slot.
NATIVE FUNC BOOL GET_CHARACTER_MENU_PED_BOOL_STAT(STATSexport enum keyHash, BOOL& data, INT characterSlot = -1) = "0x22be07335de545a4" {
...
NATIVE FUNC PAGE_STATE_export enum GET_CURRENT_UGC_PAGE() = "0x0703babda39038c8" {
