...
export enum NETWORK_GAME_OPTIONS_BASIC {
...
export enum NETWORK_PROFILE_STATS_STATUS {
	NET_PS_IDLE,
	NET_PS_PENDING,
	NET_PS_SUCCESS,
	NET_PS_FAILED	
...
//PURPOSE: Game options - these should not be set to QUERY_CRITERIA_ANY
export enum NETWORK_ROS_PRIVILEGEID {
...
export enum NETWORK_SCRIPT_STATE {
...
export enum MULTIPLAYER_ACCESS_CODE {
    ACCESS_GRANTED, 
...
export enum MATCHMAKING_VALUE {
	MM_ATTR_AIM_TYPE
}

//PURPOSE: Matchmaking Query type
export enum MATCHMAKING_QUERY_TYPE {
	MQ_FRIENDS,
    MQ_SOCIAL,
    MQ_PLATFORM
}
...
//PURPOSE: Matchmaking
export enum MATCHMAKING_QUERY {
	MQ_GENERAL,
	MQ_CNC
}

//PURPOSE: Network start session type.
export enum NETWORK_AUTO_START_TYPE {
	AUTOSTART_NONE,
...
export enum PED_CLASSIFICATION {
...
export enum RESPAWN_QUERY_FLAGS {
...
export enum RESPAWN_RESULT_FLAGS {
...
export enum RESPAWN_QUERY_RESULTS {
...
export enum CONNECTION_RESPONSE_TYPES {
	RESPONSE_ACCEPTED,
	RESPONSE_REJECTED,
	RESPONSE_BUSY,
	RESPONSE_TIMED_OUT,
...
export enum TRANSITION_EVENT_TYPE {
...
export enum INVITE_REMOVE_REASON {
	REMOVE_TIMED_OUT,
	REMOVE_OLDEST,
	REMOVE_CANCELLED,
	REMOVE_ACCEPTED
...
export enum SYSTEM_SERVICE_EVENT_ID {
	EVENT_SUSPENDED = 2,
	EVENT_RESUMING = 4,
...
export enum JOB_CONTENT_CREATOR {
	JOB_CONTENT_ROCKSTAR_CREATED = 0,
	JOB_CONTENT_USER_CREATED = 1
}

export enum NETWORK_RESERVATION_TYPE {
	RESERVATION_ALL = 0,
...
export enum NP_UNAVAILABILITY_REASON {
	REASON_INVALID = -1,
	REASON_OTHER,
...
/// PURPOSE
///   On xbox builds gets age group defined in export enum RL_AGEGROUP. {
///
...
NATIVE PROC NETWORK_SET_RICH_PRESENCE(PRESENCE_export enum id, STRUCT &data, INT sizeOfData, INT numFields) = "0x5f540c4c109ab569" {

/// PURPOSE:
///    Sets a rich presence string in PS3.
NATIVE PROC NETWORK_SET_RICH_PRESENCE_STRING(PRESENCE_export enum id, STRING presence) = "0x6e34665f75b2ee0a" {
...
export enum UGC_BOOL_OPTION {
	OPTION_NOT_SPECIFIED,
	OPTION_TRUE,
	OPTION_FALSE
}

export enum UGC_SORT_TYPE {
...
export enum FACEBOOK_TYPE_ERROR {
	FB_ERROR_OK,
...
export enum E_COMMERCE_STORE_BRANDING {
	CS_BRAND_NONE,
	CS_BRAND_AMMUNATION,
	CS_BRAND_PONSONBYS,
	CS_BRAND_BOBMULLET,
...
export enum E_PREMIUM_PACK_TYPE {
	EPPT_NONE,
    EPPT_STANDALONE,
...
// Status returned from PROFILE STATS READ operation.
export enum STORE_PURCHASE_LOCATION {
	SPL_UNKNOWN,
	SPL_SCUI,
...
//INFO: Add stat id.
NATIVE FUNC BOOL NETWORK_PROFILE_STATS_READER_ADD_STATID( STATSexport enum keyHash ) = "0xddf4b4c93bc9814c" {

//INFO: Retrieve the value for a certain stat. If noValue is set to true then it means the value does not exist yet.
NATIVE FUNC BOOL NETWORK_PROFILE_STATS_READER_GET_STAT_VALUE( STATSexport enum keyHash, GAMER_HANDLE& gamerHandle, INT& i_value, FLOAT& f_value, INT& noValue ) = "0x924911e50692ed38" {
...
export enum PLAYER_REVIEW_MODE {
...
export enum UDS_ACTIVITY_END_REASON {
...
export enum NET_SC_MEMBERSHIP_EVENT_TYPE {
...
export enum NET_SC_BENEFITS_EVENT_TYPE {
