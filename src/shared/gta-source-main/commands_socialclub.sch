...
//
//
HASH_export enum INBOX_MSG_TYPE {
	INVALID = 0,
	StatUpdate,
	FriendCrewJoined,
	FriendCreatedCrew,
...
HASH_export enum SCMSG_SENDTYPE_ENUM {
	SC_Send_AllFriends,
	SC_Send_Crew,
...
NATIVE FUNC BOOL SC_INBOX_SEND_AWARD_MSG(SCMSG_SENDTYPE_export enum sendType, STRING awardType, FLOAT amount) = "0x4f37752cba432541" {
...
export enum eEMAIL_RETRIEVAL_STATUS {
...
HASH_export enum SC_PRES_ATTR_ID_ENUM {
	mp_mis_str,
	mp_mis_inst,
	mp_team,
	mp_cash,
...
NATIVE FUNC BOOL SC_PRESENCE_ATTR_SET_INT(SC_PRES_ATTR_ID_export enum valueId, INT value) = "0x0b0cea604d2360ab" {
NATIVE FUNC BOOL SC_PRESENCE_ATTR_SET_FLOAT(SC_PRES_ATTR_ID_export enum valueId, FLOAT value) = "0x39a629d663853569" {
NATIVE FUNC BOOL SC_PRESENCE_ATTR_SET_STRING(SC_PRES_ATTR_ID_export enum valueId, STRING value) = "0x148a0559a9e2d543" {
...
export enum ePROFANITY_CHECK_STATUS {
	PROFANITY_RESULT_OK,
...
export enum eLICENSEPLATE_CHECK_STATUS {
...
export enum eLICENSEPLATE_ADD_STATUS {
	LICENSEPLATE_ADD_OK,
...
export enum ePlateDataValuesBits {
...
export enum eLICENSEPLATE_CHANGE_STATUS {
...
export enum eLICENSEPLATE_ISVALID_STATUS {
...
HASH_export enum NEWS_STORY_TYPE {
	newswire,
	store,
	rockstareditor,
	starterpackowned,
