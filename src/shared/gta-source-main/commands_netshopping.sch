...
export enum NET_GAMESERVER_TRANSACTION_STATUS {
...
export enum CATALOG_ITEM_FLAGS {
...
HASH_export enum ITEM_ACTION_TYPES {
...
HASH_export enum TRANSACTION_TYPES {
...
HASH_export enum SHOP_ITEM_CATEGORIES {
	CATEGORY_CLOTH
	,CATEGORY_WEAPON
	,CATEGORY_WEAPON_MOD
	,CATEGORY_MART
...
HASH_export enum TRANSACTION_SERVICES {
	SERVICE_INVALID
