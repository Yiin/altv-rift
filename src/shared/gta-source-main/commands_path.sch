...
// export enum : GET_SAFE_COORD_FLAGS {
...
export enum VEHICLE_PATH_DIRECTIONS {
	// Unable to decide
...
export enum VEHICLE_NODE_PROPERTIES {
...
export enum BLOCKING_OBJECT_FLAGS {
