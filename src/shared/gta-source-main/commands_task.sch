...
// Cover exit types
STRICT_export enum COVER_EXIT_TYPE {
	IDLE_COVER_EXIT = 1,
	AIMING_COVER_EXIT = 2,
	CORNER_COVER_EXIT = 3
}
...
HASH_export enum SCRIPT_TASK_NAME {
	SCRIPT_TASK_ANY,
	SCRIPT_TASK_INVALID,
	SCRIPT_TASK_PAUSE,
...
//  See the definition of export enum ANIMATION_FLAGS (above) for more information on the anim flags {
//
...
//  
//  DRIVINGSTYLE can be found in the DRIVINGSTYLE export enum in "commands_vehicle.sch" in X:\GTA\gta_rage_scripts\include\ {
//  DRIVINGMODE can be found in the DRIVINGMODE export enum in "commands_vehicle.sch" in X:\GTA\gta_rage_scripts\include\ {
...
export enum STEALTH_KILL_TASK_FLAGS {
	SKTF_DEFAULT = 0,
...
export enum VEHICLE_ESCORT_TYPE {
...
//  The MOBILE_PHONE_SUB_TASK export enum is also declared in commands_task.sch.  {
