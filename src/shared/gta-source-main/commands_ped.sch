...
export enum PEDGROUP_FORMATION {
    FORMATION_LOOSE,
...
export enum DEFAULT_TASK_ALLOCATOR {
...
export enum ALLOWED_PED_DECISION_MAKERS {
...
export enum DEFAULT_DECISION_MAKERS {
    DM_PED_GANG                 = 65536,    
...
STRUCT MP_OUTFITS_DATA_REQUEST
	BOOL 					bMale
	MP_OUTFIT_export enum 			eOutfit			= OUTFIT_MP_DEFAULT {
ENDSTRUCT
...
export enum VEHICLE_ENTRY_CONFIG_FLAGS {
	VC_NONE = 0,
...
STRICT_export enum PED_CONFIG_FLAGS {
...
// match these with the enum in PedFlagsMeta.h
STRICT_export enum PED_RESET_FLAGS {
...
export enum RAGDOLL_BLOCKING_FLAGS {
    RBF_NONE					= 0,
    RBF_BULLET_IMPACT			= 1,
...
export enum PED_DECORATION_ZONE		// This must match PedDamage.h ePedDamageZones enum {
    PDZ_TORSO = 0,	
    PDZ_HEAD,
    PDZ_LEFT_ARM,
    PDZ_RIGHT_ARM,
...
export enum PED_BLOOD_DAMAGE_TYPE		// This must match the first entries in PedDamage.h ePedDamageTypes enum {
...
export enum NM_FEEDBACK_TYPES {
    NM_FB_SUCCESS = 0,
    NM_FB_FAILURE,
    NM_FB_FINISH
}

export enum LEG_IK_MODE {
...
export enum RANDOM_PED_MODEL {
    RPM_DONT_CARE,
    RPM_MALE_PED,
    RPM_FEMALE_PED
}

export enum LADDER_INPUT_STATE {
	LIS_NOTHING = 0,
	LIS_CLIMB_DOWN,
	LIS_CLIMB_UP
}
...
export enum COMBAT_ABILITY_LEVEL {
...
STRICT_export enum COMBAT_ATTRIBUTE       //Set a specific combat attribute {
    CA_INVALID						= -1,	
...
export enum COMBAT_INFO_TYPE {
    CI_DEFAULT = -455129387,
    CI_GRUNT = 1805487359,
    CI_CAPTAIN = -384210918
}

export enum COMBAT_TARGET_LOSS_RESPONSE {
    TLR_EXIT_TASK = 0,
    TLR_NEVER_LOSE_TARGET = 1,
	TLR_SEARCH_FOR_TARGET = 2 
}

export enum STEALTH_ATTRIBUTE                      // Set a specific stealth attribute {
...
export enum PED_MOTION_STATE	// must be kept in sync with the motion state enum in PedMotionStates.h {
...
export enum PED_PARACHUTE_STATE {
...
export enum PED_PARACHUTE_LANDING_TYPE {
	PPLT_INVALID	= -1,
	PPLT_SLOW		= 0,
	PPLT_REGULAR	= 1,
	PPLT_FAST		= 2,
...
export enum FIRING_PATTERN_HASH {
...
export enum SPAWNPOINTS_RESULT_FLAGS {
...
export enum PED_VISEME_FLAGS {
	PVF_NONE = 0, //0
	PVF_ALLOW_VISEME_ANIMS_AUDIO = 1 //1<<0
}

export enum PED_DECORATIONS_STATE {
    PDS_IN_PROGRESS = 0,
    PDS_NO_DECORATIONS,
    PDS_READY
}
...
export enum ALTERNATE_ANIM_TYPE {
    AAT_IDLE,
    AAT_WALK,
    AAT_RUN,
    AAT_SPRINT
...
//INFO: 
//PARAM NOTES: EventType should be one of the export enum values in event_enums.sch {
