...
//	This export enum should only be used with the SET_INPUT_EVENT scaleform method {
export enum SCALEFORM_INPUT_EVENT {
...
export enum INSTRUCTIONAL_BUTTON_NUMBER {
...
export enum CONTROL_ACTION_GROUP {
    	INPUTGROUP_MOVE = 0,
    	INPUTGROUP_LOOK,
    	INPUTGROUP_WHEEL, 
