...
export const routes = [discordAuthRoute, createCharacterRoute, inGameRoute, craftingOneRoute, weaponShopRoute, clothesRoute, weaponModulesRoute, craftingItemsRoute];
