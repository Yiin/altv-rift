        ...
        <summary class="flex cursor-pointer items-center justify-between gap-1.5 text-white">
            ...
            <span class="relative h-5 w-5 shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="absolute inset-0 h-5 w-5 opacity-100 group-open/task:opacity-0" fill="none" viewBox="0 0 24 24"
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="absolute inset-0 h-5 w-5 opacity-0 group-open/task:opacity-100" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
