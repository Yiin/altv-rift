  ...
  <div v-if="conversation" class="w-full h-full flex items-end justify-center">
    <div class="p-24 text-white text-shadow">
      <div class="flex items-center gap-4">
        ...
        <h2 v-if="conversation.topic" class="text-xl px-2 py-0.5 bg-neutral-900 rounded">
          {{ conversation.topic }}
        </h2>
      </div>
      ...
      <div class="text-2xl flex gap-2 flex-col items-center mt-4 font-bold pb-4 uppercase tracking-wide">
        <div v-for="(option, index) in conversation.options" :key="option.label" :class="[
